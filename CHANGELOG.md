...
## [0.1.5](https://github.com/davidturnbull/dotdeps/compare/v0.1.4...v0.1.5) - 2026-01-29

### Fixed

- *(update)* avoid GitHub API by using release redirect and direct asset downloads

## [0.1.4](https://github.com/davidturnbull/dotdeps/compare/v0.1.3...v0.1.4) - 2026-01-29

### Added

- *(deps)* auto-update gitignore when deps directory is created
